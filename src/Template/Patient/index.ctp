...
/**
  ...
  * @var \App\Model\Entity\Patient[]|\Cake\Collection\CollectionInterface $patient
  */
?>
...
<div class="patient index large-9 medium-8 columns content">
    <h3><?= __('Patient') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('zipcoder') ?></th>
